...
import com.nelson.test.dao.model.DepartmentExample.Criteria;
import com.nelson.test.dao.model.DepartmentExample.Criterion;
...
public class DepartmentSqlProvider {
    ...
    public String insertSelective(Department record) {
        ...
        if (record.getFatherId() != null) {
            sql.VALUES("father_id", "#{fatherId,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getFatherId() != null) {
            sql.SET("father_id = #{record.fatherId,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(Department record) {
        ...
        if (record.getFatherId() != null) {
            sql.SET("father_id = #{fatherId,jdbcType=INTEGER}");
        }
